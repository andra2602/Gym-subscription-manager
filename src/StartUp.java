...
public class StartUp {
    public static void main(String[] args) {
        ...
        TrainerService trainerService = new TrainerService(trainerDAO, timeSlotDAO, bookingDAO, fitnessClassDAO, paymentDAO, reviewDAO, userDAO, memberDAO, classParticipantsDAO);
        ManagerService managerService = new ManagerService();
        FitnessClassService fitnessClassService = new FitnessClassService(fitnessClassDAO, bookingDAO, paymentDAO, classParticipantsDAO, promotionDAO);
        ...
        while (!exit) {
            ...
            switch (option) {
                case 1:
                    ...
                    break;
                case 2:
                    memberService.addNewSubscription(member,promotionService, scanner);
                    break;
                case 3:
                    memberService.editSubscription(member, scanner);
                    break;
                case 4:
                    memberService.deleteSubscription(member, scanner);
                    break;
                case 5:
                    fitnessClassService.listFitnessClasses();
                    break;
                    ...
                    while (!backToMain) {
                        ...
                        switch (choice) {
                            case 1:
                                ...
                                break;
                            case 2:
                                trainerService.addFitnessClass(scanner, trainer);
                                break;
                            case 3:
                                trainerService.deleteFitnessClass(scanner, trainer);
                                break;
                            case 4:
                                backToMain = true;
                                break;
